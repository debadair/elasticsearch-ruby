  ...
  module Cat
      module Actions
        ...
        def thread_pool(arguments={})
          raise ArgumentError, "Required argument 'thread_pool_patterns' missing" unless arguments[:thread_pool_patterns]
          ...
          method = HTTP_GET
          path   = Utils.__pathify "_cat/thread_pool", Utils.__listify(_thread_pool_patterns)
